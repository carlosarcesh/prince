...
import DetalleTrx from './detalles/DetalleTrx';
...
class ComprasExitosas extends Component {
    constructor(props) {
        super(props);
        this.state = {
            complejos_data: [],
    ...
    buscarTransacciones() {
        ...
        fetch(base.path.transacciones_taquilla, {
            method: 'POST',
    ...
    botonEstadoPago(cell, row) {
        return (
            ...
            }} disabled={(row.monto_total === 0 || functions.getCountry() === 'chile')}>
        ...
        return (
            <div className="animated fadeIn">
                ...
                <Modal isOpen={this.state.showDetalle} toggle={this.showDetalleModalToggle} className="modal-lg">
                    ...
                    <ModalBody>
                        <DetalleTrx params={this.state.entity}/>
                    </ModalBody>
                    <ModalFooter>
...
export default ComprasExitosas;
