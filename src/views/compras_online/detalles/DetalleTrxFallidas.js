...
class DetalleTrxFallidas extends Component {
    constructor(props) {
        super(props);
    ...
    loadTaquillaDetalles() {
        ...
        if (_booking_id != null) {
            ...
            fetch(base.path.transacciones_taquilla_det_fallidas, {
                method: 'POST',
    ...
    loadDulceriaDetalles() {
        ...
        if (_booking_id != null) {
            ...
            fetch(base.path.transacciones_dulceria_fallidas, {
                method: 'POST',
                headers: base.default_headers,
                body: JSON.stringify({
                    complejo: _complejo,
    ...
    precioFormatter(cell, row) {
        if (cookie.load('pais') == 'peru') {
            return parseFloat(cell - row.comision).toFixed(2);
        } else {
            return parseFloat(cell - row.comision).toFixed(0);
        }
    }
            ...
            <div>
                ...
                <div className="row">
                    <div className="col-lg-6">
                        ...
                        <div className="row">
                            <div className="col-lg-4 font-weight-bold">
                                {this.state.pais == 'peru' && 'Serie y Corr.:'}
                                {this.state.pais == 'chile' && 'Folio:'}
                            </div>
                            <div className="col-lg-8">
                ...
                {(this.state.has_taq || this.state.has_dul) &&
                <div>
                    <hr/>
                    <Nav tabs>
                        <NavItem>
                    ...
                    < TabContent activeTab={this.state.activeTab}>
                        ...
                        <TabPane tabId="1">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <BootstrapTable data={this.state.taq_det} striped={true} hover={true}
                                                    pagination={true}
                        ...
                        <TabPane tabId="2">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <BootstrapTable data={this.state.dul_det} striped={true} hover={true}
                                                    pagination={true}
                                                    options={tbl_options} version='4'>
...
export default DetalleTrxFallidas;
